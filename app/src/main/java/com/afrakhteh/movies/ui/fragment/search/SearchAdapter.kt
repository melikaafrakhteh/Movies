...
class SearchAdapter(
        private val movie: ArrayList<MainSearch>,
        private val context: Context
) : RecyclerView.Adapter<SearchAdapter.viewHolder>() {

    fun loadData(newList: List<MainSearch>){
        movie.clear()
    ...
    class viewHolder(
        ...
        fun bind(movies: MainSearch, context: Context) {
        ...
        private fun fetchData(model: MainSearch) {
